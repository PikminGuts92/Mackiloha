...
namespace SuperFreqCLI
{
    class Program
    {
        ...
        {
            Parser.Default.ParseArguments<Dir2MiloOptions, FixHdrOptions, HashFinderOptions, Milo2DirOptions, Milo2GLTFOptions, PngToTextureOptions, TextureToPngOptions>(args)
